...
const locais = [
  ...
  // adicione aqui novos locais (ex.: "Scripps" ou "Miss Krishna Hotels")
  // { nome: "Scripps", coords: [-23.553, -46.613] }
];
...
// --------- Funcionalidade de rotas (Leaflet Routing Machine) ---------
let routeControl = null;
let summaryDiv = null;

// Cria UI flutuante com selects e botões
function createRoutingUI() {
  const container = document.createElement('div');
  container.id = 'routing-ui';
  container.style.maxWidth = '520px';
  container.style.margin = '12px auto'; // centraliza horizontalmente abaixo do mapa
  ...
  // Insere o container logo após o mapa (fica abaixo do #map)
...
// --- Cole esta função antes de showRouteSummary ---
...
function makeRoute(startCoords, endCoords) {
  ...
  // cria novo controle de rota usando OSRM (serviço público)
  ...
  // quando as rotas são encontradas, exibe distância/tempo
  ...
  // trata erros de roteamento (opcional)
...
function showRouteSummary(text) {
  ...
  summaryDiv.style.margin = '6px auto'; // centralizado e abaixo do painel de rotas
  ...
  // tenta inserir depois do painel de rotas, se existir
...
// Inicializa UI de rotas
createRoutingUI();

// Opcional: adicionar controle de geocoding (busca por endereço) no canto
